    ...
    <div className="grid min-h-[70vh] place-items-center px-5 py-8">
      <div className="grid w-[min(430px,100%)] justify-items-center gap-5 rounded-2xl border border-border bg-white p-9 shadow-[0_22px_60px_rgba(16,24,40,0.10)]">
        ...
        <div className="text-center">
          <p className="text-[13px] font-black text-[#b3293b]">เริ่มต้นกับเรา</p>
          <h1 className="mb-1.5 mt-1 text-[28px] font-black leading-tight">สมัครสมาชิก</h1>
          <p className="text-sm leading-relaxed text-muted">สร้างบัญชีเพื่อช้อปและเติมเงินในร้าน</p>
        </div>
        ...
        <form action={register} className="grid w-full gap-3">
          <label className="grid gap-1.5 text-sm">
            <span className="font-extrabold">ชื่อผู้ใช้</span>
          ...
          <button type="submit" className="btn-accent mt-1 h-[42px] w-full">สมัครสมาชิก</button>
        </form>

        <p className="text-sm text-muted">
          มีบัญชีอยู่แล้ว? <Link href="/login" className="font-bold text-accent">เข้าสู่ระบบ</Link>
        </p>
      </div>
    </div>
  );
